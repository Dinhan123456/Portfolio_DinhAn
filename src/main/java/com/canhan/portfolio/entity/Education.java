package com.canhan.portfolio.entity;
...
public class Education {
    ...
    public Education(String universityName, String degree, String program, String coursesTaken, LocalDate startDate,
            LocalDate endDate, String imagePath) {

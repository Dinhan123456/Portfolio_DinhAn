...
import com.canhan.portfolio.entity.*;
...
public class BaseController {
    ...
    private void getSkillAttributes(Model theModel) {
        ...
        List<Skill> coreSkills = skillService.getSkillsByCategory("Core skills");
        ...
        List<Skill> career = skillService.getSkillsByCategory("Career");

        theModel.addAttribute("languages", languages);
        theModel.addAttribute("coreSkills", coreSkills);
        theModel.addAttribute("frameworks", frameworks);
        theModel.addAttribute("devOpsTools", devOpsTools);
        theModel.addAttribute("career", career);
    }
//    Languages: Java, JS, TS, SQL, HTML, CSS.
//
//    Core skills: nền tảng thuật toán, OOP, clean code.
//
//            Frameworks: Spring, React, Bootstrap…
//
//    DevOps: Git, CI/CD, Deployment.
//
//            Career: Scrum, CV, phỏng vấn.
    ...
    public String homeView(Model theModel,
            @RequestParam(value = "rateLimitError", required = false) String rateLimitError) {
